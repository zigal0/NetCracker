...
public class ConstructorOfSqlQuery {
     ...
     *
     * @throws NoSuchElementException - if conditions are not defined
     */
    public void createSqlQuery() throws NoSuchElementException {
        if (conditionGroup == null) {
    ...
    /**
     * Saves sql query into "instruction.sql" file.
     *
     * @throws NoSuchElementException - if sql is not created
     */
    public void saveFile() throws NoSuchElementException {
        if (sql == null) {
            throw new NoSuchElementException();
        }
        try {
